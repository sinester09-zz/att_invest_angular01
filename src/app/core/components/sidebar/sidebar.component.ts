...
export class AppSidebarComponent implements OnInit, OnDestroy
{
     ...
     * @param {AppSidebarService} appSidebarService
     * @param {AppMatchMediaService} appMatchMediaService
     */
    constructor(
    ...
    private _setupLockedOpen(): void
    {
        ...
        this._onMediaChangeSubscription =
            ...
            this.appMatchMediaService.onMediaChange.subscribe(() => {
                ...
                if ( isActive )
                {
                    ...
                    if ( this.appConfigService.config.layout.navigationFolded )
                    {
                        this.fold();
                    }
